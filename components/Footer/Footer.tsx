...
const Footer = () => {
  return (
      ...
      <div>
      <hr />
      <div className='px-8 xl:px-14 xxl:px-[10rem] xll:px-[20rem] xxx:px-[22%] lll:px-[25%]
       py-[80px] flex flex-col lg:flex-row items-center justify-between gap-8'>
            ...
            <div className='w-full lg:w-[52%]'>
                  ...
                  <div className='flex items-center justify-between px-4 py-3 border rounded-full'>
                        ...
                        <button className='block sm:flex items-center w-[30%] gap-2 bg-red-500 text-white rounded-full px-3 sm:px-9 py-2 shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]'>
                              <h5 className='font-semibold text-[10px] xs:text-[16px]'>Subscribe</h5>
                              <ArrowRight className='text-white hidden sm:block' />
                        </button>
                  </div>
            </div>
      </div>
